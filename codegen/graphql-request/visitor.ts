...
> {
  ...
  constructor(
    ...
    this._additionalImports.push(
      `${typeImport} { GraphQLClient } from 'graphql-request';`
    )
    ...
    if (this.config.rawRequest) {
      this._additionalImports.push(
        `${typeImport} { GraphQLError } from 'graphql-request/dist/types';`
      )
      this._additionalImports.push(
        `${typeImport} { Headers } from 'graphql-request/dist/types.dom';`
      )
    }
